...
var _rvnaddrjs = require("rvnaddrjs");

var _rvnaddrjs2 = _interopRequireDefault(_rvnaddrjs);
...
var Address = function () {
  ...
  _createClass(Address, [{
    ...
    value: function toLegacyAddress(address) {
      ...
      switch (prefix) {
        ...
        case "rvntest":
          ...
          break;
        case "rvnreg":
          ravencoin = _coininfo2.default.ravencoin.regtest;
          break;
        default:
    ...
    key: "toAddress",
    value: function toAddress(address) {
      ...
      var rvnAddress = _rvnaddrjs2.default.encode(prefixString, decoded.type, decoded.hash);

      if (prefix) return rvnAddress;
      return rvnAddress.split(":")[1];
    }
    ...
    key: "hash160ToAddr",
    value: function hash160ToAddr(hash160) {
      var network = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _ravencoinjsLib2.default.networks.ravencoin.pubKeyHash;
      var regtest = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    key: "_decodeAddress",
    value: function _decodeAddress(address) {
      if (address.indexOf(":") !== -1) {
        var decoded = _rvnaddrjs2.default.decode(address);
        decoded.format = "rvnaddr";
        return decoded;
      }
      ...
      for (var i = 0; i < prefixes.length; ++i) {
        try {
          var _decoded = _rvnaddrjs2.default.decode(prefixes[i] + ":" + address);
          _decoded.format = "rvnaddr";
          return _decoded;
        } catch (error) {}
      }
    ...
    value: function _encodeAddressFromHash160(address) {
      try {
        return {
          ...
          rvnAddress: this.hash160ToAddr(address),
          format: "hash160"
        };
      } catch (error) {}
    ...
    value: function isAddress(address) {
      return this.detectAddressFormat(address) === "rvnaddr";
    }
  }, {
    key: "isHash160",
    ...
    value: function fromOutputScript(scriptPubKey) {
      ...
      return this.toAddress(_ravencoinjsLib2.default.address.fromOutputScript(scriptPubKey, netParam), true, regtest);
    }
  }, {
    key: "details",
