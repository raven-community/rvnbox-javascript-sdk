...
var Address = function () {
  ...
  _createClass(Address, [{
    ...
    value: function _decodeLegacyAddress(address) {
      var _Ravencoin$address$fr = _ravencoinjsLib2.default.address.fromBase58Check(address),
          version = _Ravencoin$address$fr.version,
          hash = _Ravencoin$address$fr.hash;
