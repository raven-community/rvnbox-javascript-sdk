...
var TransactionBuilder = function () {
  ...
  function TransactionBuilder() {
    var network = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : "ravencoin";
    ...
    this.transaction = new _ravencoinjsLib2.default.TransactionBuilder(ravencoinJSLib);
