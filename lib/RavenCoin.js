...
var _satoshiRavencoin = require("satoshi-ravencoin");

var _satoshiRavencoin2 = _interopRequireDefault(_satoshiRavencoin);
...
var RavenCoin = function () {
  ...
  _createClass(RavenCoin, [{
    ...
    value: function toSatoshi(coins) {
      return _satoshiRavencoin2.default.toSatoshi(coins);
    }
    ...
    key: "toRavencoin",
    value: function toRavencoin(satoshi) {
      return _satoshiRavencoin2.default.toRavencoin(satoshi);
    }
    ...
    key: "satoshiToBits",
    value: function satoshiToBits(satoshi) {
      return parseFloat(satoshi) / 100;
    }
    ...
    value: function signMessageWithPrivKey(privateKeyWIF, message) {
      ...
      if (network === "testnet") ravencoin = _coininfo2.default.ravencoin.main;else ravencoin = _coininfo2.default.ravencoin.test;
