...
var RavenCoin = function () {
  ...
  _createClass(RavenCoin, [{
    ...
    value: function toRavenCoin(corbes) {
      return _corbeRavencoin2.default.toBitcoin(corbes);
    }
    ...
    key: "corbesToBits",
    value: function corbesToBits(corbes) {
      return parseFloat(corbes) / 100;
    }
    ...
    value: function signMessageWithPrivKey(privateKeyWIF, message) {
      ...
      var ravencoinBitcoinJSLib = ravencoin.toBitcoinJS();
      var keyPair = _ravencoinjsLib2.default.ECPair.fromWIF(privateKeyWIF, ravencoinBitcoinJSLib);
    ...
    value: function encodeBIP21(address, options) {
      ...
      return _bip2.default.encode(this._address.toAddress(address, true, regtest), options);
    }
