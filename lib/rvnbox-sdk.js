...
var _RavenCoin = require("./RavenCoin");

var _RavenCoin2 = _interopRequireDefault(_RavenCoin);
...
var RVNBOXSDK = function RVNBOXSDK(config) {
  _classCallCheck(this, RVNBOXSDK);

  if (config && config.restURL && config.restURL !== "") this.restURL = config.restURL;else this.restURL = "http://trest.ravencoin.online/v2/";

  this.Address = new _Address2.default(this.restURL);
  this.RavenCoin = new _RavenCoin2.default(this.Address);
  ...
  this.Asset = new _Asset2.default(this.restURL);
};

exports.default = RVNBOXSDK;